...
interface TypeBViewProps {
  claims: Claim[];
  exemptionReasonCounts: Record<string, number>;
  isLoading?: boolean;
}

const TypeBView: React.FC<TypeBViewProps> = ({ claims, exemptionReasonCounts, isLoading = false }) => {
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          ...
          <div key={item.label} className="bg-card rounded-card border border-border p-4 text-center">
            ...
            {isLoading
              ? <Skeleton className="h-[26px] w-[40px] mx-auto my-1" />
